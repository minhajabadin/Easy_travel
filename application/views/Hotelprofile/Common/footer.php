    ...
    <!-- /#wrapper -->
	  ...
	  <script src= "<?php echo $js ?>moment-2.2.1.js"></script>
	  <script src="<?php echo $js ?>clndr.js"></script>
	  <script src="<?php echo $js ?>site.js"></script>
	
        <script src="<?php echo $js ?>jClocksGMT.js"></script>
        <script src="<?php echo $js ?>jquery.rotate.js"></script>
