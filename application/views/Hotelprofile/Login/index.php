...
<body id="login">
  ...
  <h2 class="form-heading">Hoteliers login</h2>
  
  <div class="app-cam">
      <h4><?php echo $this->session->flashdata('notification'); ?></h4>
      <form action="<?php site_url('login')?>" method="POST">
          <input name="l_email" type="text" class="text" value="E-mail address" autocomplete="on" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'E-mail address';}">
		<input name="l_password" type="password" value="Password" autocomplete="on" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}">
